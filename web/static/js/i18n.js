...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "chart.mc.note":    "The <em>success rate</em> above is the % of simulations where the portfolio never depletes. Use the scenario-specific safe withdrawal rate shown here instead of a universal rule of thumb.",
    ...
    ja: {
      ...
      "chart.mc.note":    "上の<em>成功率</em>は、ポートフォリオが一度も枯渇しなかったシミュレーションの割合です。一般的な目安ではなく、このシナリオ専用に計算された安全な取り崩し率を確認してください。",
